...
namespace Nez.GeonBit
{
    ...
    public interface IEntity
    {
        ...
        void Draw(GeonNode parent, ref Matrix localTransformations, ref Matrix worldTransformations);
        ...
        BoundingBox GetBoundingBox(GeonNode parent, ref Matrix localTransformations, ref Matrix worldTransformations);
        ...
        BoundingSphere GetBoundingSphere(GeonNode parent, ref Matrix localTransformations, ref Matrix worldTransformations);
