...
namespace Betreten_Verboten.Components.Base.Boards.BV
{
    public class BVPlusBoard : BVBoard
    {
        ...
        private Matrix[] transmatrices0 = { Matrix.CreateRotationZ(MathHelper.PiOver2 * 3), Matrix.Identity, Matrix.CreateRotationZ(MathHelper.PiOver2), Matrix.CreateRotationZ(MathHelper.Pi) };
        //Enthält Transform-Matritzen, welche die SPielfeld-Hitboxen um den Spielfeld-Mittelpunkt rotieren.
        private float[] rotato0 = { 0, MathHelper.PiOver2, MathHelper.Pi, MathHelper.PiOver2 * 3 };
