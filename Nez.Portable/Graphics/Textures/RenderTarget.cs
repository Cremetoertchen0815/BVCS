...
namespace Nez.Textures
{
    public class RenderTarget : GlobalManager
    {
        ...
        /// </summary>
        public static RenderTarget2D Create() => Create(Screen.Width, Screen.Height, Screen.BackBufferFormat, Screen.PreferredDepthStencilFormat);
        ...
        public static RenderTarget2D Create(DepthFormat preferredDepthFormat) => Create(Screen.Width, Screen.Height, Screen.BackBufferFormat, preferredDepthFormat);
