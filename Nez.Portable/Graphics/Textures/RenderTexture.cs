...
namespace Nez.Textures
{
    ...
    public class RenderTexture : IDisposable
    {
        ...
        /// </summary>
        public RenderTexture() => RenderTarget = Textures.RenderTarget.Create(Screen.Width, Screen.Height, Screen.BackBufferFormat,
        ...
        public RenderTexture(DepthFormat preferredDepthFormat) => RenderTarget = Textures.RenderTarget.Create(Screen.Width, Screen.Height, Screen.BackBufferFormat,
        ...
        /// </summary>
        public void ResizeToFitBackbuffer() => Resize(Screen.Width, Screen.Height);
