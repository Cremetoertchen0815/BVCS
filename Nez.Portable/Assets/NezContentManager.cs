...
namespace Nez.Systems
{
    ...
    public class NezContentManager : ContentManager
    {
        ...
        public SpriteAtlas LoadSpriteAtlas(string name, bool generateOutline, bool premultiplyAlpha = false)
        {
            ...
            var atlas = SpriteAtlasLoader.ParseSpriteAtlas(name, this, generateOutline, premultiplyAlpha);

            if (LoadedAssets.ContainsKey(name) && LoadedAssets[name] is byte[]) LoadedAssets.Remove(name);
