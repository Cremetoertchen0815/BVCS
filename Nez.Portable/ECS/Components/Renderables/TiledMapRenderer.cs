...
namespace Nez
{
    public class TiledMapRenderer : RenderableComponent, IUpdatable
    {
        ...
        protected override void Render(Batcher batcher, Camera camera)
        {
            ...
            {
                TiledRendering.RenderMap(TiledMap, batcher, Entity.Transform.Position + _localOffset, Transform.Scale, LayerDepth, new RectangleF(camera.Bounds.Center - Screen.Center, Screen.Size));
            }
            else
            {
