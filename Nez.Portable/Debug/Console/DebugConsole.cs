...
namespace Nez.Console
{
    public partial class DebugConsole
    {
        ...
        private float _repeatCounter = 0;
        private Keys? _repeatKey = null;
        private bool _canOpen;
        private bool wasMouseVisible;

        private static Regex _charFilter = new Regex("");
        private static bool _ger = true;
        public static bool UseGermanKeyboardLayout
        {
            get => _ger;
            set
            {
                _ger = value;
                ConsoleKey = _ger ? Keys.Add : Keys.OemTilde;
            }
        }

        public static Keys ConsoleKey = Keys.Add;
#if DEBUG
        ...
        private void BuildCommandsList()
        {
            ...
            try
            {
                ...
                object domain = appDomainType.GetRuntimeProperty("CurrentDomain").GetMethod.Invoke(null, new object[] { });
